...
@section('content')
<div class="container">
    <div id="registrer" class="row justify-content-center">
        <div class="col-md-8">
            <div class="card mt-5">
                ...
                <div class="card-body">
                    <form enctype="multipart/form-data" method="POST" action="{{ route('register') }}">
                        ...
                        <div class="form-group row">
                        <label for="lastname" class="col-md-4 col-form-label text-md-right">{{ __('Efternavn') }}</label>
                        ...
                        <div class="form-group row ">
                            <label for="zipval" class="col-md-4 col-form-label text-md-right">{{ __('Postnummer') }}</label>

                            <div class="col-md-6 location selector">
                                <input id="location" placeholder="Søg postnummer" type="text" class="form-control{{ $errors->has('zipval') ? ' is-invalid' : '' }}" name="zipval" value="{{ old('zipval') }}" required autocomplete="none">
